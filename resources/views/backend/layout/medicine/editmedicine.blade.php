    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        @endif
          ...
          <!-- /.box-header -->
           <form name="myForm" role="form" action="{{route('medicine.update',$medicine_edit->id)}}" method="post" enctype="multipart/form-data" >
            @csrf
            ...
            @method('put')
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="kv-avatar">
                      <div class="file-loading">
                          <input value="{{$medicine_edit->image}}" required name="image" id="product_image"  type="file">
                      </div>
                  </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input value="{{$medicine_edit->sale_price}}" required name="sale_price" type="text" class="form-control" id="sale_price" name="sale_price"
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <select value="{{$medicine_edit->type_id}}" class="form-control select_group" id="type" name="type" required="">
                ...
                <div class="form-group">
                    ...
                    <select value="{{$medicine_edit->generic_id}}" class="form-control select_group" id="generic_type" name="generic" required="">
                ...
                <div class="form-group">
                  ...
                  <select value="{{$medicine_edit->availability}}" class="form-control" id="availability" name="availability" required="">
